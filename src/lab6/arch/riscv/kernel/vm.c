...
void setup_vm(void) { 
    ...
    */
    ...
    early_pgtbl[VPN2] = (uint64)(0 | 0x20000000U | 15U);
    // 映射到高地址
    VA = VM_START;
...
void create_mapping(uint64 *pgtbl, uint64 va, uint64 pa, uint64 sz, int perm) {
    ...
    */
    while (sz--) {
        uint64 vpn2 = (va & 0x0000007FC0000000) >> 30;
        uint64 vpn1 = (va & 0x000000003FE00000) >> 21;
        uint64 vpn0 = (va & 0x00000000001FF000) >> 12;
...
void setup_vm_final(void) {
    ...
    __asm__ volatile("csrw satp, %0":: "r"(new_satp):);
